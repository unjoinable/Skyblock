...
public class DamageCalculator {
     ...
     * @return A built SkyblockDamage object with calculated values
     */
    public static SkyblockDamage calculateAbilityDamage(CombatEntity source, CombatEntity target, Ability ability) {
        StatProfile sourceStats = source.getStatProfile();
        ...
        double baseAbilityDamage = ability.getBaseAbilityDamage();
        double abilityScaling = ability.getAbilityScaling();
        DamageType damageType = ability.getDamageType();
