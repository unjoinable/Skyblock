...
public class ItemCommand extends SkyblockCommand {
     ...
     * Sets up command syntaxes for giving an item to the command sender or to a specified target player. Item
     * suggestions are populated from the item registry.
     *
