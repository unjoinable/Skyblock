...
public enum ItemSlot {
    HELMET(player -> Skyblock.getInstance().getServerBootstrap().getProcessor().toSkyblockItem(player.getInventory().getItemStack(EquipmentSlot.HELMET.armorSlot()))),
    CHESTPLATE(player -> Skyblock.getInstance().getServerBootstrap().getProcessor().toSkyblockItem(player.getInventory().getItemStack(EquipmentSlot.CHESTPLATE.armorSlot()))),
    LEGGINGS(player -> Skyblock.getInstance().getServerBootstrap().getProcessor().toSkyblockItem(player.getInventory().getItemStack(EquipmentSlot.LEGGINGS.armorSlot()))),
    BOOTS(player -> Skyblock.getInstance().getServerBootstrap().getProcessor().toSkyblockItem(player.getInventory().getItemStack(EquipmentSlot.BOOTS.armorSlot()))),

    MAIN_HAND(player -> Skyblock.getInstance().getServerBootstrap().getProcessor().toSkyblockItem(player.getItemInMainHand())),
    ;
