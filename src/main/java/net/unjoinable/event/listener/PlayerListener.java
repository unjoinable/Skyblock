...
public class PlayerListener {
    /**
     * A thread-safe mapping of armor materials to their corresponding equipment slots.
     * Used to quickly determine which equipment slot should be updated when armor is equipped.
     */
    private static final Map<Material, ItemSlot> ARMOR_SLOT_MAP = new ConcurrentHashMap<>();

    /**
     * The global event handler used to register all player-related event listeners.
     */
